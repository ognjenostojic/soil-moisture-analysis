...
output_dir <- "/home/xosto002/Beachelor_thesis/Project/BoxPlots_Level2/Grigorten_RMSE_L02"
...
write.csv(rmse_results, sprintf("%s/RMSE_results_SMI_L02.csv", output_dir), row.names = FALSE)
