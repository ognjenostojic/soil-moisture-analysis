...
output_dir <- "/home/xosto002/Beachelor_thesis/Project/BoxPlots_Level3/Grigorten_RMSE_L03"
...
cat("✅ Boxplot saved:", sprintf("%s/RMSE_Boxplot_SMI_Level3.pdf", output_dir), "\n")
